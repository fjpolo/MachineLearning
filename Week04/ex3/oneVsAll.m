...
%
for i = 1:num_labels
  initial_theta = zeros(n+1,1); %N+1 vector
  options = optimset('GradObj', 'on', 'MaxIter', 50);
  ...
  %In the exercise example, there are 10 rows, of 401 elements each. You know 
  %this because that's how all_theta was initialized in line 15 of the script 
  %template.
  all_theta(i, :) = theta';
end
% =========================================================================
